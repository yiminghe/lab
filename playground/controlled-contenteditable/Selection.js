...
import { activeOverlayStyle, cursorStyle, inActiveOverlayStyle, selectionOverlayStyle } from './constants.js';
import {
    closest,
    constrain,
    getEqDatasetQuery,
...
export default class Selection {
    ...
    blur = () => {
        ...
        const lineDiv = Array.from(this.overlay.querySelectorAll('[data-selection-overlay]'));
    ...
    isCollapsed() {
        if (this.selection) {
            ...
            return isTextNode(anchorNode) && anchorNode === focusNode && anchorOffset === focusOffset && anchorNode === focusNode;
        }
        return false;
    }
    ...
    draw() {
        ...
        if (this.isCollapsed()) {
            ...
            let { anchorNode, anchorOffset, focusNode, focusOffset, focusElement, anchorElement } = extendSelection(this.selection);
