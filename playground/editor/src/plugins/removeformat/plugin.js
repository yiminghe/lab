  ...
  function (editor) {
    editor.addPlugin('removeformat', function () {
      var S = KISSY,
         ...
         */
        removeFormatTags =
          'b,big,code,del,dfn,em,font,i,ins,kbd,' +
          ...
          for (var i = 0, range; (range = ranges[i]); i++) {
            ...
            var breakParent = function (node) {
              ...
              for (
                ...
                if (
                  pathElement._4e_equals(path.block) ||
            ...
            var currentNode = startNode._4e_nextSourceNode(
              true,
              KEN.NODE_ELEMENT,
            );
            ...
            while (currentNode) {
              ...
              if (currentNode._4e_equals(endNode)) break;
