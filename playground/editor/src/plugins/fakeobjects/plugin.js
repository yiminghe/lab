  ...
  function (editor) {
      ...
      elements: {
        ...
        $: function (element) {
          var attributes = element.attributes,
            ...
            realFragment =
              realHtml &&
              new HtmlParser.Fragment.FromHtml(decodeURIComponent(realHtml)),
          ...
          if (realElement && element.attributes._ke_resizable) {
            ...
            if (style) {
              ...
              if (width) realElement.attributes.width = width;

              if (height) realElement.attributes.height = height;
            }
          }
          return realElement;
        },
    ...
    if (dataProcessor) {
      S.mix(dataProcessor, {
         ...
         * @param isResizable
         */
        createFakeParserElement: function (
          realElement,
          className,
          realElementType,
          isResizable,
          ...
          if (isResizable) attributes._ke_resizable = isResizable;
        ...
        createFakeElement: function (
          ...
          var self = this,
            attributes = {
              class: className,
              src: SPACER_GIF,
              _ke_realelement: encodeURIComponent(
                outerHTML || realElement._4e_outerHtml(),
              ),
