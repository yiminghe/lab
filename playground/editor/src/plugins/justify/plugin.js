    ...
    editor.addPlugin('justify', function () {
      ...
      var JustifyTpl = {
        ...
        selectionChange: function (ev) {
          ...
          var align =
            block.css('text-align').replace(alignRemoveRegex, '') ||
            //默认值，没有设置
            default_align;
      ...
      var alignleft = editor.addButton(
        'alignleft',
        S.mix(
          {
      ...
      var aligncenter = editor.addButton(
        'aligncenter',
        S.mix(
          {
      ...
      var alignright = editor.addButton(
        'alignright',
        S.mix(
          {
