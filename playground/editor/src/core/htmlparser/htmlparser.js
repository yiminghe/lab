...
*/
KISSY.Editor.add('htmlparser', function () // editor
{
  var S = KISSY,
    NULL = null,
    emptyFunc = function () {},
      ...
      while ((parts = this._.htmlPartsRegex.exec(html))) {
        ...
        if ((tagName = parts[3])) {
          ...
          var attribs = {},
            ...
            attribsPart = parts[4],
            selfClosing = !!(
              attribsPart && attribsPart.charAt(attribsPart.length - 1) == '/'
            );
          ...
          if (attribsPart) {
            while ((attribMatch = attribsRegex.exec(attribsPart))) {
              var attName = attribMatch[1].toLowerCase(),
                attValue =
                  attribMatch[2] || attribMatch[3] || attribMatch[4] || '';
          ...
          if (!cdata && XHTML_DTD.$cdata[tagName]) cdata = [];
