...
KISSY.Editor.add('select', function () {
  ...
  S.extend(Select, S.Base, {
    ...
    _prepare: function () {
      ...
      if (self.get(TITLE)) {
        new Node(
          "<div class='ke-menu-title ke-select-menu-item' " +
            "style='" +
            'margin-top:-6px;' +
            "' " +
            '>' +
      ...
      if (self.get('doc')) Event.on(self.get('doc'), 'click', deactivate);
      ...
      context = {
        ...
        reload: function (cfg) {
          ...
          self.on('selectionChange', function () {
            ...
            btnCfg.selectionChange &&
              btnCfg.selectionChange.apply(context, arguments);
          });
