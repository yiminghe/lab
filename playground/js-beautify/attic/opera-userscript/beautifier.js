...
*/
  ...
  function js_beautify(js_source_text, options) {
    ...
    var opt_braces_on_own_line = options.braces_on_own_line
      ? options.braces_on_own_line
      : false;
    ...
    var opt_space_after_anon_function =
      options.space_after_anon_function === 'undefined'
        ? false
        : options.space_after_anon_function;
  ...
  var tidy =
    ...
    String.prototype.tidy =
      function () {
        return js_beautify(toString.call(this));
      });
