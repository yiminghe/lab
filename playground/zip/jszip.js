...
JSZip.prototype.add = function (name, data, o) {
  o = o || {};
  //added native gbk for chinese word
  name = JSZipBase64._transfer(GBKEncode(name));
  name = this.root + name;
  ...
  //add by http://yiminghe.javaeye.com
  //utf-8 supported for other language
  else if (data) {
    data = JSZipBase64.utf8Encode(data);
  }
