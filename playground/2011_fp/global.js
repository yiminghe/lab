...
TB.add('mod~global', function () {
  var S = KISSY,
    ...
    APPID =
      'g_config' in win
        ? 'appId' in win['g_config']
          ? parseInt(win['g_config']['appId'])
          : undefined
        : undefined,
    MINICART_CLS = 'mini-cart',
    MINICART_NO_LAYER_CLS = 'mini-cart-no-layer',
    ...
    runItems = {
      ...
      tDog: function () {
        ...
        if (
          ...
          S.ready(function () {
            var url =
              'http://' + assetsHost + '/p/header/webww.js?t=20110513.js';
            S.getScript(url);
          });
        }
      },
      ...
      tLabs: function () {
        ...
        S.ready(function () {
          ...
          if ('ks-local' in urlConfig) {
            url =
              'http://test.taobao.com/code/fed/2010/tlabs/combo.php?b=src&' +
          ...
          S.getScript(url, function () {
            if (typeof TLabs !== 'undefined') {
              TLabs.init(
                IS_DAILY
                  ? {
                      baseUrl: 'http://dev.labs.daily.taobao.net/l?b=/f/&f=',
                      l: l,
                    }
                  : { l: l },
              );
      ...
      initSiteNav: function () {
        var trigger = doc.getElementById('J_Service'),
          container = doc.getElementById('J_ServicesContainer'),
          node,
          URL =
            'http://www.taobao.com/index_inc/2010c/includes/get-services.php',
          CALLBACK = '__services_results';
      ...
      jsBugTracker: function () {
        ...
        win.onerror = function (m, f, l) {
          var nick = getCookie('_nk_'),
            ...
            url =
              'http://tracker.ued.taobao.net/?collect&' +
              S.param({
                url: location.href,
                error: m,
                file: f,
                ...
                login: !!(
                  (getCookie('_l_g_') && nick) ||
                  (getCookie('ck1') && trackNick)
                ),
              }) +
              '&t=' +
              +new Date();
      ...
      test: function () {
        S.ready(function () {
          if (
            location.hostname.indexOf('daily.taobao.net') > -1 &&
            location.href.indexOf('__test__') > -1
          ) {
            S.getScript(
              'http://assets.daily.taobao.net/p/test/1.0/loader.js?t=' +
                +new Date(),
            );
          }
        });
  ...
  TB.Global = {
    ...
    writeLoginInfo: function (config) {
      ...
      var self = this,
        ...
        loginUrl =
          config['loginUrl'] || loginServer + '/member/login.jhtml?f=top', // ���ڲ�Ʊ��Ӧ�ã�ֱ�Ӵ���loginUrl
      ...
      logoutUrl =
        config['logoutUrl'] || loginServer + '/member/logout.jhtml?f=top'; // ע��url
      ...
      if (self.isLogin()) {
        // �ѵ�¼����ʾ����ã�XXX��[�˳�] վ����(n)
        output =
          '��ã�<a class="user-nick" href="' +
          spaceUrl +
          '" target="_top">' +
          escapeHTML(unescape(nick.replace(/\\u/g, '%u'))) +
          '</a>��' +
          self.showVIP() +
          '<a id="J_Logout" href="' +
          logoutUrl +
        ...
        // δ��¼����ʾ����ã���ӭ���Ա���[���¼] [���ע��]
        output =
          '��ã���ӭ���Ա���<a href="' + loginUrl + '" target="_top">���¼</a>';
    ...
    showVIP: function () {
      ...
      if (S.indexOf(tag, [1, 2, 3]) > -1) {
        ret =
          ...
          vip_host +
          '" rel="nofollow" target="_top"  class="user-vip vip-icon' +
          tag +
          '" title="' +
          (tag === 1 ? '�ƽ�' : tag === 2 ? '�׽�' : '��ʯ') +
          '��Ա"> </a></span>';
        ...
        ret =
          '<span class="menu">' +
          '<span class="vip-ovl menu-bd">���Ѿ߱�VIP�ʸ�<a href="' +
          vip_host +
          '/apply_vip.htm" rel="nofollow" target="_top" >����VIPͼ��</a></span>' +
          '<a class="vip-icon0 menu-hd" rel="nofollow" target="_top" href="' +
          vip_host +
          '"> <b></b></a>' +
          '</span>';
      }
    ...
    isInList: function () {
      ...
      var tmp =
        S.indexOf(APPID, [2, 5, 6, 3, 1, 15, 19, 7, 8, 9, 17, 18, 10]) > -1 ||
        IS_TMALL ||
        domain.indexOf('tmall.net') > -1;
      // ���̲���ʾ
    ...
    getCartElem: function () {
      return (
        siteNavElem && getElementsByClassName('cart', 'li', siteNavElem)[0]
      );
    },
    /**
     * ��ʼ�� mini ���ﳵ
    ...
    initMiniCart: function () {
      ...
      var self = this,
        CARTNUM_API =
          'http://buy' + HOSTNAME + '/auction/cart/top_cart_quantity.htm?',
        request = function () {
          // �����ﳵ����
          S.getScript(
            CARTNUM_API +
              'callback=TB.Global.setCartNum' +
              '&t=' +
              S.now() +
    ...
    setCartNum: function (num) {
      ...
      elem.innerHTML =
        ...
        (showLayer ? '<i></i>' : EMPTY);
      elem.href =
        'http://ju.atpanel.com/?url=http://buy' +
        HOSTNAME +
