...
Narcissus.decompiler = (function () {
  ...
  function pp(n, d, inLetHead) {
    ...
    switch (n.type) {
      ...
      case GETTER:
      case SETTER:
        if (n.type === FUNCTION) p += 'function';
        else if (n.type === GETTER) p += 'get';
        else p += 'set';
      ...
      case LET_BLOCK:
        ...
        if (n.expression) p += pp(n.expression, d);
        else p += pp(n.block, d);
        break;
      ...
      case FOR_IN:
        ...
        p +=
          (u ? pp(u, d) : pp(n.iterator, d)) + ' in ' + pp(n.object, d) + ') ';
      ...
      case YIELD:
        p += 'yield';
        if (n.value.type) p += ' ' + pp(n.value, d);
        break;
      ...
      case ASSIGN:
        ...
        var t = n.assignOp;
        p +=
          pp(nc[0], d) + ' ' + (t ? tokens[t] : '') + '=' + ' ' + pp(nc[1], d);
        break;
      ...
      case MOD:
        var nc = n.children;
        p +=
          '(' + pp(nc[0], d) + ' ' + tokens[n.type] + ' ' + pp(nc[1], d) + ')';
        break;
