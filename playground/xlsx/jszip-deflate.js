(function () {
  ...
  (function () {
    ...
    /** @license zlib.js 2012 - imaya [ https://github.com/imaya/zlib.js ] The MIT License */ (function () {
      ...
      function K(e, d) {
        ...
        this.d = 0;
        this.buffer =
          e instanceof (C ? Uint8Array : Array)
            ? e
      ...
      function ka(e, d) {
        ...
        this.c = 0;
        d &&
          (d.lazy && (this.f = d.lazy),
          'number' === typeof d.compressionType && (this.e = d.compressionType),
          d.outputBuffer &&
            (this.b =
        ...
        switch (this.e) {
          case 0:
            ...
            for (f = a.length; c < f; ) {
              ...
              if (C) {
                for (
                  l = new Uint8Array(this.b.buffer);
                  l.length <= h + b.length + 5;
      ...
      function Ja(e, d, c) {
        ...
        for (h = 0; h < c; ++h)
          v < x ? (b[h] = 0) : ((b[h] = 1), (v -= x)),
            (v <<= 1),
            (a[c - 2 - h] = ((a[c - 1 - h] / 2) | 0) + d);
        a[0] = b[0];
        m[0] = Array(a[0]);
        g[0] = Array(a[0]);
        for (h = 1; h < c; ++h)
          a[h] > 2 * a[h - 1] + b[h] && (a[h] = 2 * a[h - 1] + b[h]),
            (m[h] = Array(a[h])),
            (g[h] = Array(a[h]));
        for (l = 0; l < d; ++l) k[l] = c;
  ...
  if (!JSZip.compressions['DEFLATE']) {
    ...
    JSZip.compressions['DEFLATE'].compressInputType = USE_TYPEDARRAY
      ? 'uint8array'
      : 'array';
  }
})();
