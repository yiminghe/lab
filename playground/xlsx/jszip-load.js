...
(function (root) {
  ...
  ZipEntry.prototype = {
    ...
    prepareContent: function (
      ...
      return function () {
        var compressedFileData = JSZip.utils.transformTo(
    ...
    readLocalPart: function (reader) {
      ...
      if (this.loadOptions.checkCRC32) {
        this.decompressed = JSZip.utils.transformTo(
          'string',
  ...
  ZipEntries.prototype = {
    ...
    readCentralDir: function () {
      ...
      while (
        this.reader.readString(4) === JSZip.signature.CENTRAL_FILE_HEADER
      ) {
        file = new ZipEntry(
          {
            zip64: this.zip64,
    ...
    readEndOfCentral: function () {
      ...
      if (
        ...
        offset = this.reader.lastIndexOfSignature(
          JSZip.signature.ZIP64_CENTRAL_DIRECTORY_LOCATOR,
        );
        if (offset === -1) {
          throw new Error(
