(function () {
  ...
  var M = function (i) {
    ...
    oa = function () {
      var i = window,
        f = w;
      if (i && i.gaGlobal && i.gaGlobal.hid) f = i.gaGlobal.hid;
      else {
        f = W();
    ...
    pa = function (i, f) {
      ...
      if (f) m.id = f;
      (
        ca.getElementsByTagName('head')[0] || ca.getElementsByTagName('body')[0]
      ).appendChild(m);
    };
  var ra = function (i, f) {
      this.Wa = i;
      ...
      if (s[1] < 500 || j) {
        ...
        if (j || !c || s[2] >= 1) {
          ...
          g =
            ...
            '&utmn=' +
            W() +
            (M(b.hostname) ? '' : '&utmhn=' + P(b.hostname)) +
            (m.S == 100 ? '' : '&utmsp=' + P(m.S)) +
            g;
          if (0 == q || 2 == q) {
            j = 2 == q ? o : n || o;
  ...
  Y.Eb = function (i, f, m, u, l, o, k, g) {
    ...
    d.Fb = function (a, j, c, n, s) {
      var q = d.Wb(a),
        b = d.q;
      if (w == q) S(d.P, new Y.Db(b, a, j, c, n, s));
      else {
        q.zb = b;
        q.wa = a;
        q.r = j;
  ...
  var xa = function (i) {
    function f() {
      ...
      if (j && j[y] > 0)
        for (k = 0; k < j[y] && !d; k++) {
          g = j[k];
          if (R(g.name, 'Shockwave Flash'))
            d = g.description.split('Shockwave Flash ')[1];
        }
      else {
        g = g + '.' + g;
        try {
    ...
    l.Sb = function () {
      ...
      l.Za = m.ba ? f() : o;
      l.Pa = P(
        m.a.characterSet ? m.a.characterSet : m.a.charset ? m.a.charset : o,
      );
    };
    l.vc = function () {
      return (
  ...
  var $ = function () {
    ...
    o._setValue = function (h, p, t) {
      if (
        (typeof t != 'number' && (w == Number || !(t instanceof Number))) ||
        Math.round(t) != t ||
        t == NaN ||
        t == Infinity
      )
  ...
  var Aa = function (i, f, m) {
    ...
    a.ra = function (b) {
      ...
      e += '&utmhid=' + oa() + '&utmr=' + P(a.ca) + '&utmp=' + P(a.oc(b));
      return e;
    };
    a.oc = function (b) {
      var e = c.a[A];
    ...
    a.sc = function () {
      ...
      if (b) {
        ...
        if (b.domain)
          e = b.domain + '.google.com' + (b.port ? ':' + b.port : '');
        var h = 'https://www.google.com/analytics/reporting/overlay_js?gaso=';
        if (b.domain)
          h = 'https://' + e + '/analytics/reporting/overlay_js?gaso=';
        h += b.token + B + W();
        pa(h, '_gasojs');
      }
    };
    a.cc = function () {
      ...
      if (c.z) {
        E =
          c.a[A] && c.a[A].hash
            ? c.a[A].href.substring(c.a[A].href.indexOf('#'))
            : '';
        if (c.Y && !M(E)) T = E + B;
        T += c.a[A].search;
        if (!M(T) && R(T, D)) {
    ...
    a.fc = function () {
      if (!X.eb) {
        var b = c.a[A].hash;
        if (b && 1 == b.indexOf('gaso=')) b = O(b, 'gaso=', B);
        else
          b =
            (b = c.e.name) && 0 <= b.indexOf('gaso=')
              ? O(b, 'gaso=', B)
              : O(a.i.k(), ha, ';');
        if (b[y] >= 10) {
          a.M = b;
    ...
    a._setTrans = function () {
      ...
      if (b && b.value) {
        ...
        for (b = 0; b < p[y]; b++) {
          ...
          if ('T' == e[0])
            a._addTrans(e[1], e[2], e[3], e[4], e[5], e[6], e[7], e[8]);
          else 'I' == e[0] && a._addItem(e[1], e[2], e[3], e[4], e[5], e[6]);
        }
      }
    };
    ...
    a._trackEvent = function (b, e, h, p) {
      ...
      if (w != b && w != e && '' != b && '' != e) {
        ...
        (b =
          ...
          t._setKey(5, 2, e) &&
          (w == h || t._setKey(5, 3, h)) &&
          (w == p || t._setValue(5, 1, p))) && a._sendXEvent(t);
      } else b = v;
      return b;
    };
    a.zc = function (b, e, h) {
    ...
    a.Ya = function (b, e) {
      ...
      if (h || typeof h == 'undefined')
        if (!e.target || e.target == '_self') c.e[A] = e.href;
        else if (e.target == '_top') c.e.top.document[A] = e.href;
        else if (e.target == '_parent') c.e.parent.document[A] = e.href;
    };
    a.Jb = function (b) {
      if (!b) b = c.e.event;
      var e = b.shiftKey || b.ctrlKey || b.altKey;
      if (!e)
        if (b.modifiers && c.e.Event)
          e =
            b.modifiers & c.e.Event.CONTROL_MASK ||
            b.modifiers & c.e.Event.SHIFT_MASK ||
            b.modifiers & c.e.Event.ALT_MASK;
      return e;
    };
    a.Ec = function () {
      return c;
  ...
  function Ga() {
    var i = window[aa];
    if (i && typeof i._getTracker == 'function') X = i;
    else window[aa] = X;
  }
  function Ha() {
    var i = window[ba],
