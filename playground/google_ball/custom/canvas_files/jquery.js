...
(function () {
  ...
  o.fn = o.prototype = {
    ...
    clone: function (G) {
      var E = this.map(function () {
        if (!o.support.noCloneEvent && !o.isXMLDoc(this)) {
          ...
          return o.clean([
            I.replace(/ jQuery\d+="(?:\d+|null)"/g, '').replace(/^\s*/, ''),
          ])[0];
        } else {
    ...
    add: function (E) {
      return this.pushStack(
        o.unique(
          o.merge(this.get(), typeof E === 'string' ? o(E) : o.makeArray(E)),
        ),
      );
    },
    is: function (E) {
    ...
    val: function (K) {
      ...
      return this.each(function () {
        ...
        if (o.isArray(K) && /radio|checkbox/.test(this.type)) {
          this.checked =
            o.inArray(this.value, K) >= 0 || o.inArray(this.name, K) >= 0;
        } else {
          if (o.nodeName(this, 'select')) {
            var N = o.makeArray(K);
            o('option', this).each(function () {
              this.selected =
                o.inArray(this.value, N) >= 0 || o.inArray(this.text, N) >= 0;
            });
            if (!N.length) {
      ...
      if (this[0]) {
        ...
        if (H) {
          for (var G = 0, E = this.length; G < E; G++) {
            L.call(
              K(this[G], H),
              this.length > 1 || G > 0 ? I.cloneNode(true) : I,
            );
          }
        }
        if (F) {
  ...
  o.extend({
    ...
    prop: function (H, I, G, F, E) {
      ...
      return typeof I === 'number' && G == 'curCSS' && !b.test(E)
        ? I + 'px'
        : I;
    },
    className: {
      ...
      remove: function (E, F) {
        if (E.nodeType == 1) {
          E.className =
            F !== g
              ? o
                  .grep(E.className.split(/\s+/), function (G) {
      ...
      has: function (F, E) {
        return (
          F && o.inArray(E, (F.className || F).toString().split(/\s+/)) > -1
        );
      },
    },
    swap: function (H, G, I) {
    ...
    css: function (H, F, J, E) {
      if (F == 'width' || F == 'height') {
        var L,
          G = { position: 'absolute', visibility: 'hidden', display: 'block' },
        ...
        function I() {
          ...
          o.each(K, function () {
            ...
            if (E === 'margin') {
              ...
              L -=
                parseFloat(o.curCSS(H, 'border' + this + 'Width', true)) || 0;
            }
          });
        }
        if (H.offsetWidth !== 0) {
          ...
          if (
            ...
            if (G[J].nodeType === 1) {
              G.splice.apply(
                G,
                [J + 1, 0].concat(
                  o.makeArray(G[J].getElementsByTagName('script')),
                ),
              );
            }
            I.appendChild(G[J]);
    ...
    attr: function (J, G, K) {
        ...
        if (G in J && H && !F) {
          ...
          if (G == 'tabIndex') {
            ...
            return I && I.specified
              ? I.value
              : J.nodeName.match(/(button|input|object|select|textarea)/i)
              ? 0
              : J.nodeName.match(/^(a|area)$/i) && J.href
              ? 0
              : g;
          }
          return J[G];
      ...
      if (!o.support.opacity && G == 'opacity') {
        if (L) {
          J.zoom = 1;
          J.filter =
            (J.filter || '').replace(/alpha\([^)]*\)/, '') +
            (parseInt(K) + '' == 'NaN' ? '' : 'alpha(opacity=' + K * 100 + ')');
        }
        return J.filter && J.filter.indexOf('opacity=') >= 0
          ? parseFloat(J.filter.match(/opacity=([^)]*)/)[1]) / 100 + ''
          : '';
      }
  ...
  (function () {
    ...
    var F = function (Y, U, ab, ac) {
      ...
      if (Z.length > 1 && M.exec(Y)) {
        ...
        var ae = ac
          ...
          : F.find(
              Z.pop(),
              Z.length === 1 && U.parentNode ? U.parentNode : U,
              Q(U),
            );
        ...
        if (!X) {
          ...
          if (U.nodeType === 1) {
            for (var aa = 0; ai[aa] != null; aa++) {
              if (
                ai[aa] &&
                (ai[aa] === true || (ai[aa].nodeType === 1 && K(U, ai[aa])))
              ) {
                ab.push(af[aa]);
              }
            }
    ...
    var I = (F.selectors = {
      ...
      preFilter: {
        CLASS: function (W, U, V, T, Z, aa) {
          ...
          for (var X = 0, Y; (Y = U[X]) != null; X++) {
            if (Y) {
              if (
                Z ^ (Y.className && (' ' + Y.className + ' ').indexOf(W) >= 0)
              ) {
                if (!V) {
                  T.push(Y);
                }
      ...
      filter: {
        ...
        CLASS: function (U, T) {
          return (
            (' ' + (U.className || U.getAttribute('class')) + ' ').indexOf(T) >
            -1
          );
        },
        ATTR: function (Y, W) {
          ...
          return T == null
            ...
            ? Z.indexOf(U) === 0
            : X === '$='
            ? Z.substr(Z.length - U.length) === U
            : X === '|='
            ? Z === U || Z.substr(0, U.length + 1) === U + '-'
            : false;
        },
  ...
  o.event = {
    add: function (I, F, H, K) {
      ...
      var E = o.data(I, 'events') || o.data(I, 'events', {}),
        J =
          o.data(I, 'handle') ||
          o.data(I, 'handle', function () {
            return typeof o !== 'undefined' && !o.event.triggered
      ...
      o.each(F.split(/\s+/), function (M, N) {
        ...
        if (!L) {
          ...
          if (
            !o.event.special[N] ||
            o.event.special[N].setup.call(I, K, O) === false
          ) {
          ...
          o.each(H.split(/\s+/), function (M, O) {
            ...
            if (G[O]) {
              ...
              if (!F) {
                if (
                  !o.event.special[O] ||
                  o.event.special[O].teardown.call(K, Q) === false
                ) {
    ...
    fix: function (H) {
      ...
      if (!H.relatedTarget && H.fromElement) {
        H.relatedTarget =
          H.fromElement == H.target ? H.toElement : H.fromElement;
      }
      ...
      if (
        !H.which &&
        (H.charCode || H.charCode === 0 ? H.charCode : H.keyCode)
      ) {
  ...
  o.fn.extend({
    ...
    die: function (F, E) {
      o(document).unbind(
        i(F, this.selector),
        E ? { guid: E.guid + this.selector + F } : null,
      );
      return this;
    },
  });
  ...
  (function () {
    ...
    o.support = {
      ...
      objectAll:
        !!K.getElementsByTagName('object')[0].getElementsByTagName('*').length,
          ...
          if (L == 'success' || L == 'notmodified') {
            F.html(
              E
                ? o('<div/>')
                    .append(
                      M.responseText.replace(/<script(.|\s)*?\/script>/g, ''),
                    )
                    .find(E)
                : M.responseText,
            );
  ...
  o.extend({
    ...
    ajax: function (M) {
      ...
      if (M.dataType == 'jsonp') {
        if (G == 'GET') {
          if (!M.url.match(F)) {
            M.url +=
              (M.url.match(/\?/) ? '&' : '?') + (M.jsonp || 'callback') + '=?';
          }
        } else {
          if (!M.data || !M.data.match(F)) {
            M.data =
              (M.data ? M.data + '&' : '') + (M.jsonp || 'callback') + '=?';
          }
        }
        M.dataType = 'json';
      }
      ...
      try {
        ...
        J.setRequestHeader(
          'Accept',
          M.dataType && M.accepts[M.dataType]
            ? M.accepts[M.dataType] + ', */*'
            : M.accepts._default,
        );
      } catch (S) {}
          ...
          if (!K && J && (J.readyState == 4 || X == 'timeout')) {
            ...
            R =
              X == 'timeout'
                ...
                : !o.httpSuccess(J)
                ? 'error'
                : M.ifModified && o.httpNotModified(J, M.url)
                ? 'notmodified'
                : 'success';
            if (R == 'success') {
              try {
    ...
    httpSuccess: function (F) {
      try {
        return (
          (!F.status && location.protocol == 'file:') ||
  ...
  o.fn.extend({
    ...
    toggle: function (G, F) {
      ...
      return o.isFunction(G) && o.isFunction(F)
  ...
  o.fx.prototype = {
    ...
    cur: function (F) {
      ...
      return E && E > -10000
        ? E
        : parseFloat(o.curCSS(this.elem, this.prop)) || 0;
    },
    ...
    step: function (H) {
      ...
      if (H || G >= this.options.duration + this.startTime) {
        ...
        ](this.state, J, 0, 1, this.options.duration);
  ...
  o.each(['Left', 'Top'], function (F, E) {
    ...
    o.fn[G] = function (H) {
      ...
      return H !== g
        ? this.each(function () {
            this == l || this == document
              ? l.scrollTo(!F ? H : o(l).scrollLeft(), F ? H : o(l).scrollTop())
              : (this[G] = H);
          })
