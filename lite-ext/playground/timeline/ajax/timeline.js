...
function createTimeline(container, gateway) {
        ...
        for (var i = input.length - 1; i >= 0; i--) {
            ...
            if ("plan_work_hours" in _input && "intensity" in _input && _input.plan_work_hours / _input.intensity <= 2) {
                ...
                if (project_status_name.indexOf(OVER) != -1) {
                    ...
                    //将要开始
                    if (plan_start_date && plan_start_date.getTime() > current_date.getTime()) {
    ...
    function createXhrObject() {
        var msxml_progid = ['MSXML2.XMLHTTP.6.0', 'MSXML3.XMLHTTP', 'Microsoft.XMLHTTP', // Doesn't support readyState 3.
