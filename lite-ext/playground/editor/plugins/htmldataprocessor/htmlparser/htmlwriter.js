KISSYEDITOR.add("editor-htmlparser-htmlwriter", function(KE) {
    var S=KISSY,Utils = KE.Utils;
    ...
    S.extend(HtmlWriter, KE.HtmlParser.BasicWriter, {
         ...
         *
         * By default, all elements available in the {@link XHTML_DTD.$block),
         * {@link XHTML_DTD.$listItem} and {@link XHTML_DTD.$tableContent}
