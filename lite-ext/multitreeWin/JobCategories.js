...
var theJobCategories = [
	{ key:'50',label:'计算机/互联网/通信/电子',
		...
		{ key:'5005',label:'IT-品管、技术支持及其它',
			...
			{ key:'500511',label:'用户体验设计师'} //2009-10-19 sg
			]},
		{ key:'5006',label:'通信技术',
			children:[
      ...
      { key:'500722',label:'箔绕'},
		  ...
		  { key:'500725',label:'品保主管'}, //2009-02-26 root
			...
			{ key:'500727',label:'电子装配'}, //2009-09-09 sjc
			{ key:'500728',label:'电子布线/单片机'}, //2009-09-09 sjc
			{ key:'500729',label:'JCS技术员'}, //2009-09-09 sjc
			{ key:'500730',label:'WB技术员'} //2009-09-09 sjc
			]}
		]},
	...
	{ key:'53',label:'生产/营运/采购/物流',
		...
		{ key:'5301',label:'生产/营运',
			...
			{ key:'530111',label:'化验员'},
                        ...
                        { key:'530115',label:'造纸工程师'} //2009-09-09 sjc
      ...
      { key:'530522',label:'AI工程师'}, //2009-09-09 sjc
      { key:'530523',label:'陶瓷品制作'}, //2009-09-09 sjc
      { key:'530524',label:'硫化工'}, //2009-10-19 sg
      { key:'530525',label:'齿轮加工'} //2009-10-19 sg
			]},
		{ key:'5306',label:'服装/纺织/皮革',
			...
			{ key:'530610',label:'裁床'},
                        ...
                        { key:'530616',label:'电脑绣花'}, //2009-09-09 sjc
                        { key:'530617',label:'织造'} //2009-10-19 sg                      
			]},
		{ key:'5307',label:'采购',
			children:[
			{ key:'530701',label:'买手'},
	...
	{ key:'54',label:'生物/制药/医疗/护理 ',
		...
		{ key:'5402',label:'化工',
			...
			{ key:'540210',label:'液品制造'} //2009-11-05 root
			]},
	...
	{ key:'55',label:'广告/市场/媒体/艺术',
		...
		{ key:'5501',label:'广告',
			...
			{ key:'550112',label:'婚礼策划师'} //2009-10-19 sg
			]},
      ...
      { key:'550411',label:'灯光'} //2009.10.16 sg
                         ]},
		{ key:'5505',label:'写作/出版/印刷',
			...
			{ key:'550515',label:'主编'} //2009-10-19 sg
			]},
		{ key:'5506',label:'艺术/设计',
			...
			{ key:'550609',label:'玩具设计'},
                        ...
                        { key:'550612',label:'雕塑师'} //2009-09-09 sjc
			]}
		]},
	{ key:'56',label:'建筑/房地产',
		children:[
		{ key:'5601',label:'建筑工程',
			...
			{ key:'560117',label:'施工员'},
                        ...
                        { key:'560122',label:'高空保洁'} //2009-09-09 sjc
			]},
		{ key:'5602',label:'房地产',
			children:[
	...
	{ key:'59',label:'服务业',
		...
		{ key:'5902',label:'酒店/旅游',
			...
			{ key:'590214',label:'客户宝贝/吧丽'}, //2009-10-16 sg
			{ key:'590215',label:'出品部主管'}, //2009-10-16 sg
			{ key:'590216',label:'水果制作/吧员'}, //2009-10-16 sg
			{ key:'590217',label:'服务部经理/主管'} //2009-10-16 sg         
			]},
		...
		{ key:'5905',label:'交通运输服务',
			...
			{ key:'590510',label:'海事管理/船舶管理/船员管理'}, //2009.10.14 sg
			{ key:'590511',label:'货代/船代'}   //2009.10.14 sg
			]},
	...
	{ key:'60',label:'公务员/翻译/其他',
		...
		{ key:'6004',label:'储备干部/培训生/实习生',
			...
			{ key:'600404',label:'学员'}   //2009.10.14 sg
			]},
		{ key:'6005',label:'兼职'				// 2009.01.19 不需要两个编号 600501
			}
		]},
		{ key:'61',label:'农/林/牧/渔',
		children:[
		{ key:'6101',label:'种植'},
		{ key:'6102',label:'林业'},
		{ key:'6103',label:'畜牧业'},
